...
public class CourseTimePanel extends MPanel{
	...
	public void creatComponent(){
		...
		week = new MComboBox(weekModel, new Point(40,0), new Dimension(80,
				20));
		...
		start= new MComboBox(timeModel, new Point(130,0), new Dimension(80,
				20));
		end=new MComboBox(timeModel, new Point(220,0), new Dimension(80,
				20));
		
		timeB=new MButton(null,null,null,new Point(310,0),new Dimension(30,20));
		timeB.setText("+");
		
		timeDB=new MButton(null,null,null,new Point(0,0),new Dimension(30,20));
		timeDB.setText("-");
