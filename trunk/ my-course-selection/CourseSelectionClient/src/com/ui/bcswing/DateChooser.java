...
//		JSpinner hourSpin;
		...
		private void createYearAndMonthPanal() {
			...
			int currentMonth;
//			try {
//				Date current = DateFormat.getInstance().parse(getText());
...
//					currentHour, 0, 23, 1));
			...
			monthSpin.setPreferredSize(new Dimension(38, 25));
...
//			hourSpin.setPreferredSize(new Dimension(38, 25));
...
//		}
		...
		DateChooser chooser = new DateChooser(panel);
		chooser.setBounds(100, 100, 150, 25);
		panel.add(chooser);
		frame.add(panel);
